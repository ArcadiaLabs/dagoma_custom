...
class L3G4200D(object):
    '''
    Simple L3G4200D gyroscope implementation
    ...
    def __init__(self, bus, address, name, scale=250):
        '''
        Constructor
        '''
        ...
        if scale == 250:
        	...
        	self.fs_scale = "FS_500"
        elif scale == 2000:
        	self.fs_scale = "FS_2000"
        else:
        	self.fs_scale = "FS_250"
        ...
        ctrl_reg4 = 1 << 6 | L3G4200D.GYRO_SCALE[self.fs_scale][1] << 4
